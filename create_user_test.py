...
def negative_assert_symbol(first_name):
        ...
        # Проверяется, что статус ответа равен 400
...
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("Dima")

# Тест 6. Успешное создание пользователя
# Параметр fisrtName состоит из Русских символов

def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("Дима")

# Тест 7. Ошибка
# Параметр fisrtName имеет пробел

def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Aaa ко ко")

# Тест 8. Ошибка
# Параметр fisrtName имеет Символ

def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")

# Тест 9. Ошибка
# Параметр fisrtName имеет цифру

def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("34535")
...
# Тест 12. Ошибка
# Параметр fisrtName состоит из другого типа параметра
